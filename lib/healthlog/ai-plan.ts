...
export function buildSystemPrompt(
  ...
  return [
    ...
    "For 'what should I do' questions, prioritize the most useful fat-loss action first: complete missing food logs, hit protein target, stay within calorie deficit, or log exercise. Do not default to weight unless the user asked about weight or weighing is the clearest next step.",
    ...
    "- For action questions, choose the best goal-moving action. Do not fall back to weight logging unless weight is specifically the bottleneck or the user asked about weight.",
